...
let subTypeCount=0; //счетчик подтипов
let arrayProdSubType;
...
async function createCardProduct(collect, res){
    ...
    console.log(`arrayProdSubType == ${arrayProdSubType}`);
 ...
 */
            ...
            // console.log('mongoose.Types.ObjectId(  ===  ',id);
                                ...
                                prodCard = new mng_schemas.ProductCards( {
                                    ...
                                    productType: product_Type[prodTypeNum]._id, //код типа продукта из справочника
                                    productSubType: subTypeValue(product_Type[prodTypeNum]._id), //подтип продукта
